    ...
    <el-row :gutter="10">
      <el-col :span="12">
        ...
        <el-card >
          ...
          <div >
            <el-button v-show="snatchBtn" plain type="primary" v-loading.fullscreen.lock="fullscreenLoading" @click="snatch">抢夺</el-button>
            <el-button v-show="withdrawPoolBtn" plain type="primary" v-loading.fullscreen.lock="fullscreenLoading" @click="withdraw">领取收益</el-button>
            <el-button v-show="otherWithdrawPoolBtn" plain type="primary" v-loading.fullscreen.lock="fullscreenLoading" @click="otherWithdraw">帮助收取</el-button>
          </div>
        </el-card>
      </el-col>
      <el-col :span="12">
